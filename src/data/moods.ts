...
export const moods: Mood[] = [
  {
    ...
    comforts: [
      ...
      "Your feelings are valid. Allow yourself to feel, and know that brighter days are ahead. ☀️"
    ]
  },
  {
    id: "happy",
    ...
    comforts: [
      ...
      "Keep riding this wave of joy. You've earned every bit of it! 🏄‍♀️"
    ]
  },
  {
    id: "angry",
    ...
    comforts: [
      "Take a deep breath. It's okay to feel angry, but don't let it control you. 🌬️",
  ...
  },
  {
    ...
    jokes: [
      "Why did the bed go to school? To learn how to make itself! 🛏️",
    ...
    comforts: [
      ...
      "Even the mightiest warriors need rest. You're doing amazing. ⚔️",
  ...
  },
  {
    ...
    comforts: [
      ...
      "Ride that wave of excitement all the way to your dreams! 🏄‍♂️",
  ...
  },
  {
    ...
    jokes: [
      ...
      "Why did the pencil stink? Because it had a number two! ✏️"
    ],
    comforts: [
      "Boredom is just your mind asking for a new adventure. Try something new! 🗺️",
